           ...
           $('#name').html( data.message.custom_name);
            ...
            $.each(data.message.selection,function (n,value) {
                ...
                var ohtml=
                    ...
                    '            <video style="display: none;-moz-box-shadow:-7px -6px 14px #333333; -webkit-box-shadow:-7px -6px 14px #333333; box-shadow:-7px -6px 14px rgb(193,190,183);" height="305px" width="100%" poster="'+value.poster+'">'+
