...
$(function () {
    ...
    //渲染dom
    $.ajax({
        url: "http://weixin8.xiaoheqingting.com/app/index.php?i=1&c=entry&id=2&do=GetSelectData&m=xc_tmall&custom_id="+custom_id,
        type: "POST",   //post请求方式
        dataType: "jsonp",
        jsonp: "callback",
        success: function (data) {
            ...
            $.each(data.message.selection,function (n,value) {
                ...
                if(like=='1')
                {
                    ohtml+='            <div class="heart heartAnimation" id="like" rel="unlike"></div>';
                }
                else {
                    ohtml+='            <div class="heart" id="like" rel="like"></div>';
                }
                ...
                if(data_music=='1')
                    ohtml+= '<div class="pic_hover">';
                else
                    ohtml+= '<div class="pic_foot_2">';
            ...
            $('.confirm').on('click', function () {
                ...
                $.ajax({
                    url: "http://weixin8.xiaoheqingting.com/app/index.php?i=1&c=entry&do=SaveSelectResult&m=xc_tmall",
                    type: "POST",   //post请求方式
                    dataType: "jsonp",
                    jsonp: "callback",
                    data:obj_new,
